...
- **The measured tables themselves** (accuracy per architecture per dataset, ms/frame, the `dtime`/NMS/threshold/tracker sweeps): [`../memory/performance-log.md`](../memory/performance-log.md).
